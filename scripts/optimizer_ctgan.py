...
class CTGANBayesianOptimizer:
    """
    Advanced Bayesian Optimization for CTGAN hyperparameters using Optuna.
    ...
    def comprehensive_evaluation(self, synthesizer):
        """
        Multi-metric evaluation of CTGAN performance
        ...
        try:
            ...
            # Best evaluation metric for fidelity ("balanced_accuracy" or "f1")
    ...
    def _evaluate_fidelity(self, synthetic_data, metric_to_use="f1"):
        ...
        try:       
            ...
            if metric_to_use == "f1":
            ...
            elif metric_to_use == "balanced_accuracy":
                ...
                raise ValueError(f"Invalid metric: '{metric_to_use}'. Choose 'balanced_accuracy' or 'f1'.")
    ...
    def objective(self, trial):
        """
        Optuna objective function for CTGAN hyperparameters
        """
    ...
    def create_final_synthesizer(self):
        ...
        synthesizer_path = '../data/outputs/synthesizers/synthesizer_CTGAN_diversions_optimal.pkl'
...
def main():
    ...
    optimizer = CTGANBayesianOptimizer(
